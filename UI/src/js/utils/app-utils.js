    ...
    function (ko) {
        function appUtils() {
            ...
            self.formatDate = function (date) {
                var formatDate = oj.Validation.converterFactory(oj.ConverterFactory.CONVERTER_TYPE_DATETIME).createConverter(
                    {
                        'pattern': 'dd/MM/yyyy'
                    }
                );
            ...
            /*
            Source: http://codeaid.net/javascript/convert-size-in-bytes-to-humanreadable-format-(javascript)#comment-1
            */
